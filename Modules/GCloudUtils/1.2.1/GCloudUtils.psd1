...
RequiredModules = @('KubectlUtils', 
               'GcpUtils/1.0.0/GcpUtils.psd1', 
               'GCloudCompletion/1.0.0/GCloudCompletion.psd1')

# Assemblies that must be loaded prior to importing this module
# RequiredAssemblies = @()

# Script files (.ps1) that are run in the caller's environment prior to importing this module.
ScriptsToProcess = 'public/ContextFileUtils.ps1', 'public/Add-GKECredentials.ps1', 
...
FunctionsToExport = 'Remove-GCloudContextKey', 'Update-ContextFileMap', 
               ...
               'Get-GCloudProjectIdFromGkeContext', 'Set-GCloudContext', 
