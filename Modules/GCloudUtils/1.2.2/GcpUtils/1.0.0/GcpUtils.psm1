...
[GCloud]::SetGCloudProperties($GCloudParams)
...
$jobGcloudConfig = Start-ThreadJob -ScriptBlock {
    gcloud config set survey/disable_prompts True 2>$null
    gcloud config set disable_usage_reporting true 2>$null
}
Register-ObjectEvent -InputObject $jobGcloudConfig -EventName StateChanged -Action {
