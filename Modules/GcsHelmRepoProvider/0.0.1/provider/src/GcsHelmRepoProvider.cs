...
namespace Microsoft.Samples.PowerShell.Providers
{
    ...
    public class GoogleCloudStorageProvider : NavigationCmdletProvider, IContentCmdletProvider
    {
       ...
       #region Drive Manipulation
        ...
        protected override PSDriveInfo RemoveDrive(PSDriveInfo drive)
        {
            ...
            GoogleCloudStoragePSDriveInfo.Connection.Close();
    ...
    #region GoogleCloudStorageContentReader

    /// <summary>
    /// Content reader used to retrieve data from this provider.
    /// </summary>
    public class GoogleCloudStorageContentReader : IContentReader
    {
        ...
        internal GoogleCloudStorageContentReader(string path, GoogleCloudStorageProvider provider)
        {
            this.path = path;
    ...
    } // GoogleCloudStorageContentReader

    #endregion GoogleCloudStorageContentReader

    #region GoogleCloudStorageContentWriter

    /// <summary>
    /// Content writer used to write data in this provider.
    /// </summary>
    public class GoogleCloudStorageContentWriter : IContentWriter
    {
        // A provider instance is required so as to get "content"
        private GoogleCloudStorageProvider provider;
        private string path;
        ...
        internal GoogleCloudStorageContentWriter(string path, GoogleCloudStorageProvider provider)
        {
            this.path = path;
            this.provider = provider;
        }
    ...
    } // GoogleCloudStorageContentWriter

    #endregion GoogleCloudStorageContentWriter
