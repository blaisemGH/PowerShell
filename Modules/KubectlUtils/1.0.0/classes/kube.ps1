...
Class Kube {
	...
	static [string] $relevantContainersFile = "$HOME/Documents/kubernetes/relevantContainers.psd1"
	...
	static [string] $contextFile = "$HOME/Documents/kubernetes/contexts.psd1"
