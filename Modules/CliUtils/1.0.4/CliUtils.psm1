...
Set-Alias -Name sop		-Value Select-ObjectProperties  -Scope Global -Option AllScope
Set-Alias -Name sov		-Value Select-ObjectValues		-Scope Global -Option AllScope
